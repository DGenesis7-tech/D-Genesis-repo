...
public class vehiclesRepositoryTest {
    ...
    void setUp() {
        ...
        vehicle = new Vehicle("Toyota", "Camry", Year.of(2020), "PN1000A", "100" , new Owner("Daniel", "VI", "DD@gmail.com", 7031032739L, Gender.MALE));
    }
    ...
    public void testToPreventDuplicateVehicle() {
        vehiclesRepo.save(vehicle);
        Vehicle copy = new Vehicle("Toyota", "Camry", Year.of(2020), "PN1000A", "100" , new Owner("Daniel", "VI", "DD@gmail.com", 7031032739L, Gender.MALE));
